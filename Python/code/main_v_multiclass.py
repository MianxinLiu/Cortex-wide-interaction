        ...
        for epoch in range(EPOCH):
            for step, (b_x, b_y) in enumerate(train_loader):  # gives batch data
                ...
                if epoch >=40 and tr_accuracy>0.8:
                    ...
                    if F1 >= auc_baseline and sen_1 >= 0.30 and sen_2 >= 0.30 and sen_3 >= 0.30:
                        auc_baseline = F1
                        torch.save(model.state_dict(),'./Python/model_v/model_all_cv'+str(cv)+'_'+str(start)+'_'+ str(end)+'.pth')
